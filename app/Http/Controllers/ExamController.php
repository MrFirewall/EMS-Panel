...
use App\Events\PotentiallyNotifiableActionOccurred; // --- NEU: Event importieren ---
...
class ExamController extends Controller
{
    ...
    public function generateLink(Request $request)
    {
        ...
        // --- NEU: ACTIVITY LOG ---
        ActivityLog::create([
            'user_id' => Auth::id(), // Der Admin, der den Link generiert
            'log_type' => 'EXAM',
        ...
        // --- NEU: BENACHRICHTIGUNG VIA EVENT (an den Prüfling) ---
        PotentiallyNotifiableActionOccurred::dispatch(
            'ExamController@generateLink',
            $user,       // Der Prüfling (Empfänger der Benachrichtigung)
    ...
    public function submit(Request $request, $uuid)
    {
        ...
        // --- NEU: BENACHRICHTIGUNG VIA EVENT (an Admins/Prüfer) ---
        PotentiallyNotifiableActionOccurred::dispatch(
    ...
    public function finalizeEvaluation(Request $request, string $uuid)
    {
        ...
        DB::transaction(function () use ($attempt, $validated, $isPassed) {
            ...
            // Logeintrag (Dieser war bereits vorhanden und korrekt)
        ...
        // --- NEU: BENACHRICHTIGUNG VIA EVENT (an den Prüfling) ---
        PotentiallyNotifiableActionOccurred::dispatch(
            'ExamController@finalizeEvaluation',
