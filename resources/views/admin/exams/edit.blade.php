                             ...
                             @foreach($exam->questions as $qIndex => $question)
                                <div class="question-block card card-outline card-secondary mb-3" id="q{{ $qIndex }}">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            <button type="button" class="btn btn-sm btn-danger remove-question-btn" data-target="q{{ $qIndex }}"><i class="fas fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="q{{ $qIndex }}_type">Fragetyp</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addOption(qIndex, optionsContainer, type) {
        ...
        // Ensure first radio is checked if it's a single choice question
    ...
    container.addEventListener('click', function(e) {
        ...
        if (removeQuestionBtn) {
            const targetId = removeQuestionBtn.dataset.target;
            ...
            if (newType === 'text_field') {
                ...
                options.forEach((optionGroup, oIndex) => {
                    ...
                    if(newType === 'single_choice') {
                        ...
                        radioOrCheckbox.name = radioOrCheckbox.name.replace(/\[options\]\[\d+\]\[is_correct\]/, '[correct_option]');
                        radioOrCheckbox.value = oIndex;
                        radioOrCheckbox.checked = (oIndex === 0); // Check first option by default
