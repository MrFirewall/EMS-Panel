...
            window.Echo.connector.pusher.connection.bind('error', function(err) { /* console.error(err); */ });
            window.Echo.connector.pusher.connection.bind('connected', function() { /* console.info(); */ });
            window.Echo.connector.pusher.connection.bind('connecting', function() { /* console.info(); */ });
            window.Echo.connector.pusher.connection.bind('disconnected', function() { /* console.warn(); */ });
